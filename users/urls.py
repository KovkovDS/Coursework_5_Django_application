...
from .views import RegistrationView, email_verification, AuthorizationView, ProfileView, ProfileUpdateView, \
...
urlpatterns = [
    path('', AuthorizationView.as_view(), name='login'),
    ...
    path("profile/blocking/<int:pk>", block_user, name="blocking_profile"),
]
